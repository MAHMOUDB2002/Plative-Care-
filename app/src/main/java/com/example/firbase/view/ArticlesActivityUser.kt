...
import com.example.firbase.adapter.ArticleAdapter
import com.example.firbase.adapter.ArticleUserAdapter
import com.example.firbase.databinding.ActivityArticlesBinding
import com.example.firbase.databinding.ActivityArticlesUserBinding
import com.example.firbase.model.Article
...
class ArticlesActivityUser : AppCompatActivity() {
...
//        id = sharedP.getString("idArticle", "0").toString()
        ...
        db.collection("Article")
            ...
            .addOnSuccessListener {
                ...
                var articleAdapter = ArticleUserAdapter(this, data)
